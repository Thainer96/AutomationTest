...
public class PruebaCodigo {
	...
	public static void main(String args[]) {
		...
		//System.out.println(countDistinctIntegers(4));
		...
		System.out.println("imprimiendo suma for " + suma);
		
		suma = 0;
		int contadorWhile = 1;
		while (contadorWhile <= numero) {			
			suma = suma + contadorWhile;
			contadorWhile++;
		}
		System.out.println("imprimiendo while " + suma);
		
		
		suma = 0;
		int contadorDoWhile = 1;
		do {			
			suma = suma + contadorDoWhile;
			contadorDoWhile++;
		} while (contadorDoWhile <= numero);
		System.out.println("imprimiendo resultado while" + suma);
